...
-- AddForeignKey
ALTER TABLE "public"."BarberShopService" ADD CONSTRAINT "BarberShopService_barberShopId_fkey" FOREIGN KEY ("barberShopId") REFERENCES "public"."BaberShop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
